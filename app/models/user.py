...
class User(db.Model, UserMixin):
    ...
    phone = db.Column(db.String(120), nullable=False, default="Add Phone")
    country = db.Column(db.String(120), nullable=False, default="Add Country")
    state = db.Column(db.String(120), nullable=False, default="Add State")
